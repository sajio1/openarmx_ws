...
: ${AMENT_CURRENT_PREFIX:="/ws/install/openarmx"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/openarmx/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/openarmx/environment/path.sh"
