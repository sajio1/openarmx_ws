...
: ${AMENT_CURRENT_PREFIX:="/ws/install/openarmx_bringup"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/openarmx_bringup/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/openarmx_bringup/environment/path.sh"
