...
: ${AMENT_CURRENT_PREFIX:="/ws/install/openarmx_bimanual_moveit_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/openarmx_bimanual_moveit_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/openarmx_bimanual_moveit_config/environment/path.sh"
