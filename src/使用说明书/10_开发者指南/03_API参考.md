...
### 1.1 openarmx_hardware::OpenArmSystem
...
### 1.2 openarmx_hardware::RobstrideCAN
...
#### 1.3.1 JointTrajectoryController
...
### 2.2 MoveIt Python API

**包:** `moveit_py` (ROS2 Humble)

#### 2.2.1 MoveGroupInterface
